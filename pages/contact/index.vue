    ...
    <div class="flex flex-col justify-evenly p-4">
      <div class="mb-12 lg:w-1/2">
        ...
        <div class="text-lg flex flex-col gap-4">
          ...
          <p class="text-sm sm:text-lg">Any projects with requirements not explicitly listed under the "Won&apos;t" section is tentatively a "Will", such as Shopify, WordPress, and Mobile / Desktop apps.</p>
        </div>
      </div>
      <div>
